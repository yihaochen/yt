...
/* BEGIN: Cython Metadata
{
    ...
    "module_name": "yt.utilities.lib.argsort"
}
END: Cython Metadata */
...
#define __PYX_HAVE__yt__utilities__lib__argsort
#define __PYX_HAVE_API__yt__utilities__lib__argsort
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter;

/* "yt/utilities/lib/argsort.pyx":17
...
/* Module declarations from 'yt.utilities.lib.argsort' */
...
static int __pyx_f_2yt_9utilities_3lib_7argsort__compare(const void *, const void *); /*proto*/
static void __pyx_f_2yt_9utilities_3lib_7argsort_cyargsort(__Pyx_memviewslice, struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *); /*proto*/
static PyObject *__pyx_f_2yt_9utilities_3lib_7argsort_argsort(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "yt.utilities.lib.argsort"
int __pyx_module_is_main_yt__utilities__lib__argsort = 0;

/* Implementation of 'yt.utilities.lib.argsort' */
...
static PyObject *__pyx_pf_2yt_9utilities_3lib_7argsort_argsort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order); /* proto */
...
/* "yt/utilities/lib/argsort.pyx":21
 *     np.float64_t value
 * 
...
static int __pyx_f_2yt_9utilities_3lib_7argsort__compare(const void *__pyx_v_a, const void *__pyx_v_b) {
  ...
  /* "yt/utilities/lib/argsort.pyx":22
 * 
 * cdef int _compare(const_void *a, const_void *b):
 *     cdef np.float64_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value             # <<<<<<<<<<<<<<
 *     if v <= 0: return -1
 *     if v > 0: return 1
 */
  __pyx_v_v = (((struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *)__pyx_v_a)->value - ((struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *)__pyx_v_b)->value);

  /* "yt/utilities/lib/argsort.pyx":23
 * cdef int _compare(const_void *a, const_void *b):
 *     cdef np.float64_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value
 *     if v <= 0: return -1             # <<<<<<<<<<<<<<
 *     if v > 0: return 1
 ...
 */
  ...
  /* "yt/utilities/lib/argsort.pyx":24
 *     cdef np.float64_t v = ((<Sorter*>a)).value-((<Sorter*>b)).value
 *     if v <= 0: return -1
 *     if v > 0: return 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/utilities/lib/argsort.pyx":26
 *     if v > 0: return 1
 * 
 * cdef void cyargsort(np.float64_t[:] data, Sorter * order):             # <<<<<<<<<<<<<<
 *     cdef np.int64_t i
...
static void __pyx_f_2yt_9utilities_3lib_7argsort_cyargsort(__Pyx_memviewslice __pyx_v_data, struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *__pyx_v_order) {
  ...
  /* "yt/utilities/lib/argsort.pyx":28
 * cdef void cyargsort(np.float64_t[:] data, Sorter * order):
 *     cdef np.int64_t i
 *     cdef np.int64_t n = data.shape[0]             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  ...
  /* "yt/utilities/lib/argsort.pyx":29
 *     cdef np.int64_t i
 *     cdef np.int64_t n = data.shape[0]
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         order[i].index = i
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "yt/utilities/lib/argsort.pyx":30
 *     cdef np.int64_t n = data.shape[0]
 *     for i in range(n):
 *         order[i].index = i             # <<<<<<<<<<<<<<
 *         order[i].value = data[i]
 ...
 */
    ...
    /* "yt/utilities/lib/argsort.pyx":31
 *     for i in range(n):
 *         order[i].index = i
 *         order[i].value = data[i]             # <<<<<<<<<<<<<<
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)
 ...
 */
    __pyx_t_3 = __pyx_v_i;
    (__pyx_v_order[__pyx_v_i]).value = (*((__pyx_t_5numpy_float64_t *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_3 * __pyx_v_data.strides[0]) )));
  }

  /* "yt/utilities/lib/argsort.pyx":32
 *         order[i].index = i
 *         order[i].value = data[i]
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  qsort(((void *)__pyx_v_order), __pyx_v_n, (sizeof(struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter)), __pyx_f_2yt_9utilities_3lib_7argsort__compare);
...
/* "yt/utilities/lib/argsort.pyx":34
 *     qsort(<void *> order, n, sizeof(Sorter), _compare)
 * 
 * cpdef argsort(np.float64_t[:] data, np.int32_t[:] order):             # <<<<<<<<<<<<<<
 *     cdef np.int32_t i
...
static PyObject *__pyx_pw_2yt_9utilities_3lib_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_2yt_9utilities_3lib_7argsort_argsort(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order, CYTHON_UNUSED int __pyx_skip_dispatch) {
  __pyx_t_5numpy_int32_t __pyx_v_i;
  __pyx_t_5numpy_int32_t __pyx_v_n;
  struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *__pyx_v_order_struct;
  ...
  /* "yt/utilities/lib/argsort.pyx":36
 * cpdef argsort(np.float64_t[:] data, np.int32_t[:] order):
 *     cdef np.int32_t i
 *     cdef np.int32_t n = data.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/utilities/lib/argsort.pyx":37
 *     cdef np.int32_t i
 *     cdef np.int32_t n = data.shape[0]
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))             # <<<<<<<<<<<<<<
 *     cyargsort(data, order_struct)
 *     for i in range(n):
 */
  __pyx_v_order_struct = ((struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter *)malloc((__pyx_v_n * (sizeof(struct __pyx_t_2yt_9utilities_3lib_7argsort_Sorter)))));

  /* "yt/utilities/lib/argsort.pyx":38
 *     cdef np.int32_t n = data.shape[0]
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))
 *     cyargsort(data, order_struct)             # <<<<<<<<<<<<<<
 *     for i in range(n):
 ...
 */
  __pyx_f_2yt_9utilities_3lib_7argsort_cyargsort(__pyx_v_data, __pyx_v_order_struct);

  /* "yt/utilities/lib/argsort.pyx":39
 *     cdef Sorter *order_struct = <Sorter *> malloc(n * sizeof(Sorter))
 *     cyargsort(data, order_struct)
 *     for i in range(n):             # <<<<<<<<<<<<<<
 *         order[i] = order_struct[i].index
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "yt/utilities/lib/argsort.pyx":40
 *     cyargsort(data, order_struct)
 *     for i in range(n):
 *         order[i] = order_struct[i].index             # <<<<<<<<<<<<<<
 *     free(order_struct)
 */
    ...
    __pyx_t_4 = __pyx_v_i;
    *((__pyx_t_5numpy_int32_t *) ( /* dim=0 */ (__pyx_v_order.data + __pyx_t_4 * __pyx_v_order.strides[0]) )) = __pyx_t_3;
  }

  /* "yt/utilities/lib/argsort.pyx":41
 *     for i in range(n):
 *         order[i] = order_struct[i].index
 *     free(order_struct)             # <<<<<<<<<<<<<<
 */
...
/* Python wrapper */
static PyObject *__pyx_pw_2yt_9utilities_3lib_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_2yt_9utilities_3lib_7argsort_1argsort(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("argsort (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_order)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("argsort", 1, 2, 2, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "argsort") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_float64_t(values[0]); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    __pyx_v_order = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_int32_t(values[1]); if (unlikely(!__pyx_v_order.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("argsort", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("yt.utilities.lib.argsort.argsort", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_2yt_9utilities_3lib_7argsort_argsort(__pyx_self, __pyx_v_data, __pyx_v_order);
...
static PyObject *__pyx_pf_2yt_9utilities_3lib_7argsort_argsort(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_order) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_order.memview)) { __Pyx_RaiseUnboundLocalError("order"); __PYX_ERR(0, 34, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_2yt_9utilities_3lib_7argsort_argsort(__pyx_v_data, __pyx_v_order, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 34, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "yt.utilities.lib.argsort.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.argsort.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.argsort.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "yt.utilities.lib.argsort._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"argsort", (PyCFunction)__pyx_pw_2yt_9utilities_3lib_7argsort_1argsort, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_yt__utilities__lib__argsort) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "yt.utilities.lib.argsort")) {
      if (unlikely(PyDict_SetItemString(modules, "yt.utilities.lib.argsort", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "yt/utilities/lib/argsort.pyx":8
 * 
 * cimport numpy as np
 * import numpy as np             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/utilities/lib/argsort.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init yt.utilities.lib.argsort", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init yt.utilities.lib.argsort");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
